...
const MinimalBackground = React.memo(() => {
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-green-50 to-indigo-50"></div>
    </div>
  );
});
  ...
  return (
    <div className="bg-green-50 p-3 rounded-lg text-sm">
      <div className="flex items-center mb-1">
        ...
        <span className="font-medium text-green-700">Password Requirements</span>
      </div>
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-gray-900"
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleInputChange}
              className="w-full pl-11 pr-11 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-gray-900"
        ...
        <button
          ...
          className={`w-full py-3 rounded-lg font-medium text-white bg-green-600 
            ${isLoginFormValid && !isLoading ? 'hover:bg-green-700' : 'opacity-70 cursor-not-allowed'}
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <input
              ...
              value={formData.name}
              onChange={handleInputChange}
              className="w-full pl-10 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-gray-900"
        ...
        <div>
          ...
          <div className="mt-1 relative">
            ...
            <input
              ...
              value={formData.password}
              onChange={handleInputChange}
              className="w-full pl-10 pr-10 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all text-gray-900"
        ...
        <button
          ...
          className={`w-full py-3 rounded-lg font-medium text-white bg-green-600 
            ${isSignupFormValid && !isLoading ? 'hover:bg-green-700' : 'opacity-70 cursor-not-allowed'}
