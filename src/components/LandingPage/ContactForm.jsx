    ...
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              {isSubmitted ? (
                ...
                >
                  <div className="w-16 h-16 rounded-full bg-teal-100 flex items-center justify-center mb-4">
                    <HiOutlineCheck className="w-8 h-8 text-teal-600" />
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    type="submit"
                    className="w-full bg-gradient-to-r from-teal-500 to-blue-500 hover:from-teal-600 hover:to-blue-600 text-white font-medium py-3 px-4 rounded-lg shadow-md flex items-center justify-center"
                  ...
                  >
                    ...
                    {isLoading ? "Sending..." : "Free grading Tool 🚀"}
                  </motion.button>
                </form>
              )}
            </div>
          ...
          >
            <div className="relative">
              <div className="absolute -top-10 -left-10 w-40 h-40 bg-teal-100 rounded-full blur-2xl opacity-60"></div>
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-blue-100 rounded-full blur-2xl opacity-60"></div>
