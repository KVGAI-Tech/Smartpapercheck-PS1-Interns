...
const ClockIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Minute hand — group rotates around center */}
    <motion.g
    ...
    {/* Hour hand — shorter, rotates slower */}
    <motion.g
      style={{ originX: "12px", originY: "12px" }}
      animate={{ rotate: 360 }}
...
const ScaleIcon = ({ hovered }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Beam — tilted when not hovered, balanced when hovered */}
    <motion.g
...
// 3. Chat bubble with pulsing notification dot
const FeedbackIcon = () => (
...
// 4. Bar chart — bars animate up from 0 on inView and re-animate on hover
...
// 6. Database with spark on hover
const RubricIcon = ({ hovered }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    {/* Spark checkmark pops out on hover */}
    <motion.g
...
// 7. Image frame with tracing recognition border
const DiagramIcon = ({ hovered }) => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="3" width="18" height="18" rx="2" />
    <circle cx="8.5" cy="8.5" r="1.5" />
    <polyline points="21 15 16 10 5 21" />
    {/* Dotted recognition border traces on hover */}
    <motion.rect
...
// 8. Stacked pages that stagger upward on hover
...
const MultilingualIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={ACCENT} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10" />
    {/* Vertical meridian line rotates */}
    <motion.ellipse
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Icon container — no generic bounce, each icon animates itself */}
        ...
        {/* Back */}
        <div
          className="absolute inset-0 bg-accent rounded-xl p-6 shadow-md flex flex-col justify-center"
          style={{ backfaceVisibility: "hidden", transform: "rotateY(180deg)" }}
        >
          <h3 className="text-lg font-semibold text-white mb-3">{title}</h3>
          <p className="text-white/90 text-sm leading-relaxed">{backDetail}</p>
...
const Features = ({
  ...
  // Tab order: Features first, Benefits second
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between">
            ...
            <motion.button
              className="bg-accent px-8 py-3 rounded-full text-white font-medium transition-all duration-300 shadow-md whitespace-nowrap"
