...
const PoliciesPage = () => {
  ...
  return (
    <div className="landing-page overflow-x-hidden bg-white">
      <div className="relative h-24">
        <Navbar />
      </div>

      <div className="bg-gradient-to-r from-teal-500 to-blue-500 w-full flex flex-col items-center justify-center relative py-20">
        <h1 className="font-bold text-4xl md:text-6xl mb-6 text-center text-white">
          Policies
        </h1>
        <p className="max-w-3xl mx-auto text-xl text-white px-4">
      ...
      <Container maxWidth="lg" sx={{ py: 8 }}>
        <Box sx={{ 
          ...
          <Typography variant="body1" paragraph sx={{ color: '#374151', lineHeight: 1.7 }}>
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://www.smart-qna.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </Typography>
          <Typography variant="body1" paragraph sx={{ color: '#374151', lineHeight: 1.7 }}>
            The Platform is owned by KVGAI Tech Private Limited, a company incorporated under the Companies Act, 1956 with its registered office at B87, Indira Nagar, Lucknow ,Lucknow ,India (hereinafter referred to as "Platform Owner", 'we', 'us', 'our').
          </Typography>
          <Typography variant="body1" paragraph sx={{ color: '#374151', lineHeight: 1.7 }}>
          ...
          <Typography variant="h6" component="h3" gutterBottom sx={{ color: '#1f2937', mb: 2 }}>
          ...
          <Typography variant="body1" paragraph sx={{ color: '#374151', lineHeight: 1.7 }}>
            • All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Lucknow and Uttar Pradesh.
          </Typography>
          <Typography variant="body1" paragraph sx={{ color: '#374151', lineHeight: 1.7 }}>
        ...
        <Box sx={{ 
          ...
          <Typography variant="body1" component="ul" sx={{ color: '#374151', lineHeight: 1.7, pl: 2 }}>
            <li>• Cancellations will only be considered if the request is made 7 days of placing the order.</li>
            <li>• KVGAI Tech Private Limited does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
            ...
            <li>• In case of any refunds approved by KVGAI Tech Private Limited, it will take 7 days for the refund to be processed to you.</li>
          </Typography>
        </Box>
      </Container>
    </div>
