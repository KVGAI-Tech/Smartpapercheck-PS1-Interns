  ...
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <Box>
        ...
        <Typography variant="body1" paragraph>
          • KVGAI Tech Private Limited does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.
        </Typography>
        <Typography variant="body1" paragraph>
        ...
        <Typography variant="body1" paragraph>
          • In case of any refunds approved by KVGAI Tech Private Limited, it will take 7 days for the refund to be processed to you.
        </Typography>
      </Box>
    </Container>
  );
